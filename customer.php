<!--
 ...
 <head> 
     ...
     <title>SparkPC | Customer Details</title>
...
<div class="container-customer">
    ...
    <table>
        ...
        <?php
            $conn = mysqli_connect("localhost", "root", "1411", "mddatabase");
            // Check connection
            if ($conn->connect_error) {
            die("Connection failed: " . $conn->connect_error);
            }
            $sql = "SELECT * FROM mddatabase.users";
 ...
 <div class="footer">
     ...
     <div class="footer-center">
         <p class="footer-company-name">© Spark MD Bank 2021 | Designed by Mangesh Desai</p>          
     </div>		
 </div>
 </footer>	
 <!--end footer-->
